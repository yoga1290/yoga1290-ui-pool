...
export default ({ title, text, subtitle, click, icon }: CardProps) => (
        <div className={`card-with-icon animate__animated animate__fadeInUp col-12 d-inline-block text-center`}>

            <div className="card bg-dark col-12 border-light pointer-cursor d-inline-block py-2 my-4" tabIndex={0} onClick={!!click? click:doNothing}>
